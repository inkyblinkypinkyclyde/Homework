...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
      volume_of_cube_result = volume_of_cube(1,2,3)
      self.assertEqual( 6, volume_of_cube_result )

  #Given a String, return the String reversed
  def test_reverse_string(self):
      reverse_string_result = reverse_string("Taco cat")
      self.assertEqual( "tac ocaT", reverse_string_result)
    #add test code here

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius(self):
      fahrenheit_to_celsius_result = fahrenheit_to_celsius(-40)
      self.assertEqual( -40, fahrenheit_to_celsius_result)
    #add test code here
